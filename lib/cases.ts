...
export const cases: CaseItem[] = [
  // ===== 一、水务集团数字化运营 =====
  {
    ...
    location: "全国",
    client: "北控水务集团",
    image: "/cases/beikong-shuiwu-regions.png",
    summary:
      "依托北控水务数据标准、运营评价标准和企业知识库建设，基于 300+ 数字化项目实践持续沉淀产品能力，形成行业首个全面的企业数字化建设标准体系。",
    background:
      "北控水务集团旗下水厂数量众多、分布广泛、业态多元，需要以统一标准连接现场控制、运营管理与集团决策。项目依托数据标准、运营评价标准和企业知识库，持续沉淀可复制的数字化产品体系，支撑集团轻资产战略下的运营管理数字化转型。",
    scope: [
  ...
  },
  {
    ...
    summary:
      "面向南部区域公司及下属 10 个子公司、16 座污水处理厂，以数据中台为底座建设区域级运营管理平台，实现多源数据标准化治理与业财一体化运营。",
    background:
      "项目面向天津创业环保南部区域公司及下属 10 个子公司、16 座污水处理厂，需要在区域层面贯通经营、运营、资产、安全和质量等多源异构数据，解决集团、区域、子公司与水厂之间数据分散、标准不一和业务协同不足的问题。",
    scope: [
  ...
  // ===== 二、排水一体化管理 =====
  {
    ...
    summary:
      "覆盖 4 座污水处理厂、2 座污泥处理厂、5 个非水管理处、51 座泵站及 400 余公里管网，融合实时数据与 AI 模型构建厂、站、网一体化运营管理平台。",
    background:
      "项目覆盖城域范围内 4 座污水处理厂、2 座污泥处理厂、5 个非水管理处、51 座泵站及 400 余公里管网。面对设施类型多、空间分布广和防汛响应要求高等特点，项目依托物联数据平台、厂网一体化管理系统和城市防汛管理系统，统一构建排水运营数字底座。",
    scope: [
      "融合实时运行数据与 AI 模型能力",
  ...
  },
  {
    ...
    summary:
      "统一接入排水户、泵站、管网、排口和易涝点等设施数据，形成覆盖日常运维与内涝应急的监测、预警、处置和调度能力。",
    background:
      "项目面向大连城市排水日常运维与内涝应急管理，依托物联数据平台、厂网一体化管理系统和城市防汛管理系统，统一接入排水户、泵站、管网、排口、易涝点等设施数据，构建可持续扩展的城市排水管理平台。",
    scope: [
  ...
  // ===== 三、数字水厂 =====
  {
    ...
    summary:
      "围绕“平台底座 + 智能控制 + 智慧运营”建设，融合物联数据、三维孪生、智能巡检、机理模型与运营智能体，打造 AI 驱动的全流程智慧水厂。",
    background:
      "项目以物联数据平台汇聚全厂数据，通过三维数字孪生构建设施、设备、工艺、人员和事件的全要素数字映射，以水厂运营管理系统打通生产运营流程，并集成视觉智能算法与多模态机器人，形成数字化运营与人机协同巡检能力。",
    scope: [
      "CW-IOT 汇聚全厂数据构建平台底座",
      "CW-3DP 构建全要素三维数字映射",
      "CW-POM 打通生产运营管理流程",
  ...
  },
  {
    ...
    summary:
      "作为西安净水公司从点状智能探索迈向全局智慧运营的重要样板，项目建设数字管理平台和三维数字孪生系统，推动生产管理数据联动、流程闭环与运行态势可视化。",
    background:
      "西安市第三再生水厂智慧化项目是西安净水公司从点状智能探索迈向全局智慧运营的重要样板。项目重点建设数字管理平台与三维数字孪生系统，连接生产一线和管理后台，为多厂复制推广及厂网一体化运营构建数字基础。",
    scope: [
  ...
  },
  {
    ...
    summary:
      "作为北控水务集团标杆水厂及四川大区中心水厂，项目以多系统协同实现黑灯水厂目标，并通过 1+N 组团式管理向五座分支水厂输出智慧运营能力。",
    background:
      "塔子坝污水厂是北控水务集团标杆水厂及四川大区中心水厂。围绕黑灯水厂建设目标，项目部署水厂运营管理、数字孪生、远程运维、专家远程支持、工艺仿真和全流程智能控制等系统，形成单厂智慧运营与区域集约管控协同能力。",
    scope: [
  ...
  // ===== 四、三维数字孪生 =====
  {
    ...
    summary:
      "以数字孪生技术打造全息透明水厂，融合实时运行、工单和仿真模型数据，实现巡检、设备、控制回路及工艺过程的全面三维运营管理。",
    background:
      "西安第三再生水厂通过引入数字孪生技术，1:1 还原厂区空间、设备状态和工艺过程，并融合运营管理实时数据与工单数据，构建“数字基座 + AI 模型”的三维运营体系。",
    scope: [
  ...
  },
  {
    ...
    summary:
      "针对全地下布置、地面建设景观公园的新模式水厂，以 BIM 构建地下空间数字孪生，并融合 UWB 定位、视频识别与一键求助构建立体安全保障体系。",
    background:
      "广州增城开发区下沉式污水处理厂采用全地下布置、地面建设景观公园的新模式。地下空间结构复杂，人员与生产安全要求高，项目利用 BIM 模型构建三维数字孪生，统一展现运行状态、设备状态和工艺原理。",
    scope: [
      "利用 BIM 模型建设地下空间三维场景",
      "全面展现运行状态、设备状态及工艺原理",
  ...
  },
  {
    ...
    summary:
      "服务浦东新区城市内河运营管理，融合城市 CIM、水文、现场监测和视频数据，以“一图一屏”全景还原防汛要素并贯通泵闸运营业务。",
    background:
      "上海泵闸署城市智慧防汛项目服务于浦东新区城市内河运营管理。项目将河道防汛管理系统与三维数字孪生泵闸系统结合，整合城市 CIM 数据、水文资料、水位流量现场监测及视频数据，构建高仿真防汛场景。",
    scope: [
  ...
  },
  {
    ...
    summary:
      "面向河长制示范县建设首个大尺度、全要素流域数字孪生项目，将 45 条河流、74 宗水库和 32 宗重点山塘纳入“六个一”智慧管控体系。",
    background:
      "鹤山市是首批广东省全面推行河长制示范县之一，境内河库众多、管理对象分散。项目以二三维一体化方式建设大尺度、全要素流域数字孪生，将 45 条河流、74 宗水库和 32 宗重点山塘统一纳入河长制管理。",
    scope: [
      "一张空天地协同监测网",
