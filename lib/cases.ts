...
export const cases: CaseItem[] = [
  ...
  },
  {
    ...
    image: "/case-pom.png",
    summary:
      "为浦东水务集团构建统一的数字化运营管理体系，打通多厂生产、运营与管理数据，提升集约化运营与决策支持水平。",
    background:
      "浦东水务集团下辖多座水厂与运营单位，需要构建集团统一的数字化运营管理体系，实现生产运行、运营管理与经营分析的在线化、标准化与集约化。",
    scope: [
      "集团—厂站多层级运营管理平台",
      "生产、运营、资产数据集中汇聚",
      "统一运营指标与对标分析",
...
export const caseCoords: Record<string, [number, number]> = {
  ...
  "pudong-group": [121.6, 31.22], // 上海·浦东
