...
const tiers = [
  ...
  { n: 3, label: "平台能力层", width: "78%", icons: [Settings, Sparkles], accent: "oklch(0.66 0.16 235)" },
  { n: 2, label: "数据底座层", width: "90%", icons: [Database, Boxes], accent: "oklch(0.72 0.14 212)" },
  ...
  return (
    <div className="relative mx-auto aspect-square w-[300px] sm:w-[340px]">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div
          className="core-pulse-anim flex size-[92px] flex-col items-center justify-center rounded-full text-center"
          style={{
            animation: "core-pulse 4s ease-in-out infinite",
            background:
              "radial-gradient(circle at 50% 32%, oklch(0.85 0.13 205 / 0.98) 0%, oklch(0.55 0.18 235 / 0.95) 52%, oklch(0.32 0.16 255 / 0.98) 100%)",
          }}
        >
...
export function PlatformArchitecture() {
  return (
    <div className="relative mx-auto max-w-7xl overflow-hidden px-6 pb-10">
      ...
      {/* 三列：左卡 / 中央塔 / 右卡 */}
      <div className="relative mt-6 grid items-center gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)_minmax(0,1fr)]">
